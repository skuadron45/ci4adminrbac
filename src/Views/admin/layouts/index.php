...
<body class="sidebar-mini layout-fixed text-sm">
  ...
  <div class="wrapper">
    ...
    <!-- Navbar -->
    <?php
    echo $this->include('Ci4adminrbac\Views\admin\layouts\navbar');
    ?>
    <!-- /.navbar -->

    <!-- Main Sidebar Container -->
    <?php
    echo $this->include('Ci4adminrbac\Views\admin\layouts\sidebar');
    ?>
    <!-- /Main Sidebar Container -->
    ...
    <div class="content-wrapper">
      ...
      <?php
      echo $this->include('Ci4adminrbac\Views\admin\layouts\contentheader');
      ?>
      <!-- /.content-header -->
    ...
    <footer class="main-footer">
      <strong>Copyright &copy; 2020 - <?php echo date('Y') ?> <a href="http://adminlte.io"><?= $appName; ?></a>.</strong>
      All rights reserved.
